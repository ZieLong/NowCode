...
import com.hqu.community.dao.LoginTicketMapper;
import com.hqu.community.entity.User;
import com.hqu.community.service.FollowService;
...
public class UserController implements CommunityConstant {
    ...
    public String updatePass(@CookieValue("ticket") String ticket,
        ...
        if(!password.equals(user.getPassword())){
            model.addAttribute("oldPasswordMsg","密码错误，请输入正确的密码");
            return "site/setting";
        }
        //更新密码：插入数据库，登出用户;
